...
void Number::setNumber(int num)
{
	...
	auto num1Sprite = gcnew Sprite(IDB_PNG1, "PNG", Rect(Point(num1X, num1Y), Size(24, 36)));
	auto num2Sprite = gcnew Sprite(IDB_PNG1, "PNG", Rect(Point(num2X, num2Y), Size(24, 36)));
